  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Food Social Media platform made by <span style="font-weight: 700;">Sufyaan</span>  for testing purpose.</p>
        <p>The includes post , repost , qoute or even qoute the qouted post , like post and nested comments.
                      ...
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
                          ...
                          <label>
                            ...
                            <textarea class="text-whathappen" name="status" rows="8" cols="80" placeholder="What's on your plate insaan?"></textarea>
