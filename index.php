            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="assets/images/savvorly-logo.png" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">Show what’s on your plate right now</span>
                        <span class="join">Join Savvorly today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <section class="twt-features">
                <div class="features-div">
                    ...
                    <p>Follow your food interests.</p>
                    <img class="twt-icon" src="https://image.ibb.co/mZPTWU/heart_icon.png">
                    <p>Hear what people are talking about food.</p>
